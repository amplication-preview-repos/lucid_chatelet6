...
@InputType()
class SubscriptionCreateNestedManyWithoutAuthorsInput {
...
export { SubscriptionCreateNestedManyWithoutAuthorsInput as SubscriptionCreateNestedManyWithoutAuthorsInput };
