  ...
  test("POST /analytics", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastSaleDate: CREATE_RESULT.lastSaleDate.toISOString(),
      ...
      .expect([
        {
          ...
          lastSaleDate: FIND_MANY_RESULT[0].lastSaleDate.toISOString(),
  ...
  test("GET /analytics/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastSaleDate: FIND_ONE_RESULT.lastSaleDate.toISOString(),
